...
export default function HoldingSummary({ holdings, snapshotsByFundCode = {}, lastUpdatedAt }: HoldingSummaryProps) {
  ...
  const stats: StatItem[] = [
    ...
    { label: '持有收益率', value: totalRate !== null ? <ProfitLossValue value={totalRate} type="rate" className="text-[15px] font-bold" /> : emptyVal, icon: iconRate, accent: true, color: 'from-pink-500 to-pink-600' },
    ...
    { label: '今日收益率', value: dailyRate !== null ? <ProfitLossValue value={dailyRate} type="rate" className="text-[15px] font-bold" /> : emptyVal, icon: iconDailyRate, accent: true, color: 'from-yellow-500 to-amber-500' },
